...
public class Rectangle {
    ...
    // this is the constructor and this one takes no arguments
    public Rectangle() {
        // this is run when ever the code contains new square()
    }
    ...
    // we use what are called getters and setters to change the value of height and width
